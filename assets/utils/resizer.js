...
class Resizer {
  ...
  update(strict) {
    if (this.detector) {
      const computedStyle = window.getComputedStyle(this.detector, null)
      ...
      const callbackGroups = Object.values(this.callbacks)
  ...
  destroyCallbacks(id) {
    ...
    const cbs = new Map(Object.entries(this.callbacks))
